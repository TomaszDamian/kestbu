...
### Step 2, liður a.
Kynnið ykkur hvernig hægt er að gera [töflur](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet#tables) í MarkDown og útbúið svo töflu svipaða þeirri sem er í lið a og fyllið svo út í Function dálkinn. 
